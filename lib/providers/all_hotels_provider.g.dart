...
String _$adminAllHotelsHash() => r'ab9347acaa4457dcd670732fbddaab8cc7443349';

/// See also [adminAllHotels].
@ProviderFor(adminAllHotels)
final adminAllHotelsProvider =
    AutoDisposeFutureProvider<List<HotelModel>>.internal(
  adminAllHotels,
  name: r'adminAllHotelsProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$adminAllHotelsHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef AdminAllHotelsRef = AutoDisposeFutureProviderRef<List<HotelModel>>;
