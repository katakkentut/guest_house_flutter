...
class HouseFeedbackService {
  Future<Map<String, dynamic>> submitService(
      double houseRating, String userFeedback, String houseId) async {
    try {
      ...
      final response = await http.post(
        Uri.parse(ApiEndPoints.baseUrl +
            ApiEndPoints.userEndpoints.houseFeedback),
        body: jsonEncode({
          'houseRating': houseRating,
          'feedbackNote': userFeedback,
          'houseId': houseId,
        }),
        headers: {
