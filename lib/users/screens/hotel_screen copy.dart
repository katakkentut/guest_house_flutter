...
class _HotelDetailScreenState extends State<HotelDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: _ReserveBar(price: widget.hotel.housePrice),
    );
  }
}
...
class _ReserveBar extends StatefulWidget {
  ...
  @override
  _ReserveBarState createState() => _ReserveBarState();
}
          ...
          Column(
            ...
            children: [
              ...
              RichText(
                text: TextSpan(
                  children: [
                    AppTextSpan.large('RM ' + widget.price.toString()),
                ...
                return SizedBox(
                  ...
                  child: CustomButton(
                    ...
                    onPressed: () async {
                      ...
                      if (result == true) {
                        // The user successfully signed in, refresh the widget
                        setState(() {});
                      }
                    },
                  ),
