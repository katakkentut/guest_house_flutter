...
class $AssetsLogoGen {
  ...
  /// File path: assets/logo/airplane.png
  AssetGenImage get airplane => const AssetGenImage('assets/logo/airplane.png');

  /// File path: assets/logo/bg.png
  AssetGenImage get bg => const AssetGenImage('assets/logo/bg.png');

  /// List of all assets
  List<AssetGenImage> get values => [airplane, bg];
}

class $AssetsIconAmenitiesGen {
  const $AssetsIconAmenitiesGen();

  /// File path: assets/icon/amenities/air_conditioner.svg
  SvgGenImage get airConditioner =>
      const SvgGenImage('assets/icon/amenities/air_conditioner.svg');

  /// File path: assets/icon/amenities/bbq.svg
  SvgGenImage get bbq => const SvgGenImage('assets/icon/amenities/bbq.svg');

  /// File path: assets/icon/amenities/family.svg
  SvgGenImage get family =>
      const SvgGenImage('assets/icon/amenities/family.svg');

  /// File path: assets/icon/amenities/garden.svg
  SvgGenImage get garden =>
      const SvgGenImage('assets/icon/amenities/garden.svg');

  /// File path: assets/icon/amenities/hotel.svg
  SvgGenImage get hotel => const SvgGenImage('assets/icon/amenities/hotel.svg');

  /// File path: assets/icon/amenities/kitchen.svg
  SvgGenImage get kitchen =>
      const SvgGenImage('assets/icon/amenities/kitchen.svg');

  /// File path: assets/icon/amenities/parking.svg
  SvgGenImage get parking =>
      const SvgGenImage('assets/icon/amenities/parking.svg');

  /// File path: assets/icon/amenities/patio.svg
  SvgGenImage get patio => const SvgGenImage('assets/icon/amenities/patio.svg');

  /// File path: assets/icon/amenities/private_bathroom.svg
  SvgGenImage get privateBathroom =>
      const SvgGenImage('assets/icon/amenities/private_bathroom.svg');
  ...
  /// File path: assets/icon/amenities/tv.svg
  SvgGenImage get tv => const SvgGenImage('assets/icon/amenities/tv.svg');

  /// File path: assets/icon/amenities/view.svg
  SvgGenImage get view => const SvgGenImage('assets/icon/amenities/view.svg');
